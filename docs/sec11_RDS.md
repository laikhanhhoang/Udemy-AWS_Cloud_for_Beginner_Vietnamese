...
- [Lí thuyết](#lí-thuyết)
    - [RDS - Định nghĩa](#rds---định-nghĩa)
    - [Các tính năng cơ bản của RDS](#các-tính-năng-cơ-bản-của-rds)
    - [RDS Usecase](#rds-usecase)
    - [Các mô hình triển khai RDS](#các-mô-hình-triển-khai-rds): Single Instance, Single Instance with Multi-AZ, Master – Read Only cluster, Master – Read Only cluster with Multi-AZ, Master – Multi Read cluster.
    - [Aurora](#aurora)
    - [Parameter Groups](#parameter-groups)
        <p align="center">
            <img src="docs_imgs\rds_para_groups.png" width="450" />
        </p>
