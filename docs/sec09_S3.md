...
- [Lí thuyết](#lí-thuyết)
    ...
    - [Các tính năng cơ bản](#các-tính-năng-cơ-bản)
    - [Kết hợp dịch vụ khác với S3](#kết-hợp-dịch-vụ-khác-với-s3)
    - [S3 Storage Class](#s3-storage-class): S3 Standard, S3 Standard-IA, S3 Glacier,...
    - [S3 Lyfe Cycle](#s3-lyfe-cycle): Tính năng cho phép tự động move object xuống các class lưu trữ thấp hơn hoặc xoá luôn sau một khoảng thời gian nhằm tiết kiệm chi phí.
    - [S3 event trigger](#s3-event-trigger): cung cấp cơ chế trigger 1 event sang dịch vụ khác khi có thay đổi đối với object (upload, delete).
