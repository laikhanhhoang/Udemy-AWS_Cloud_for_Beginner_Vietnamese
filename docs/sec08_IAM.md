...
- [Lí thuyết](#lí-thuyết)
    - [Policy](#policy): quy định việc ai/cái gì có thể hoặc không thể làm gì.
    - [User](#user): dại diện cho 1 profile của 1 người dùng trên AWS account.
    - [Role](#role): cấp quyền cho 1 thực thể có thể tương tác với các resources khác trên AWS
    - [Group](#group): đại diện cho 1 nhóm user trên hệ thống.
- [Lab](#lab)
