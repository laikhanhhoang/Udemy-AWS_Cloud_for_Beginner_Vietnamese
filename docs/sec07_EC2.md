...
- **Một số khái niệm cơ bản**
    ...
    <p align="center">
        <img src="docs_imgs/ec2_term.png" width="250" />
    </p>
...
- **Vòng đời của EC2 Instance**
    - EC2 Default
        ...
        <p align="center">
            <img src="docs_imgs/lifecycle_df.png" width="450" />
        </p>
    ...
    - EC2 using instance-store volume
        ...
        <p align="center">
            <img src="docs_imgs/ec2_lifecycle_str.png" width="250" />
        </p>
...
- **Security Group**: để giới hạn truy cập tới EC2 và từ EC2 ra bên ngoài.
    ...
    <p align="center">
        <img src="docs_imgs/ec2_sec_gr.png" width="400" />
    </p>
...
- **Thao tác với máy ảo**
    ...
    - Khi muốn thao tác, nhấn nút **Connect** trên dashboard EC2 và thực hiện các thao tác cần thiết để truy cập
        <p align="center">
            <img src="docs_imgs/connect_ec2.png" width="400" />
        </p>
